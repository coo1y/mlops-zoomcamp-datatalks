...
def get_fake_input_path(year, month):
    default_input_pattern = "s3://nyc-duration/trip-data/yellow_tripdata_{year:04d}-{month:02d}.parquet"
...
def main(year: int, month: int):
    ...
    input_file = get_fake_input_path(year, month)
